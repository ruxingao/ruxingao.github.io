  ...
  $angular
    ...
    .controller("ctrl", [
      ...
      function ($scope, $timeout, storage) {
        var splashIconArray = [];
        splashIconArray = _.flatten(
          _.times(29, function (i) {
        ...
        $scope.uiPlay = function (hand) {
          ...
          var message = "";
          $scope.splashIcon =
            splashIconArray[_.random(0, splashIconArray.length - 1)];
          ...
          if ($scope.splashIcon === "spock") {
            ...
            if (hand === $scope.splashIcon) {
              ...
              if (
                (hand === "rock" && $scope.splashIcon === "scissors") ||
                (hand === "scissors" && $scope.splashIcon === "paper") ||
                (hand === "paper" && $scope.splashIcon === "rock")
              ) {
                _winner = _p1;
                message = "You won!";
              } else {
...
goHome.addEventListener("click", function (e) {
  e.stopPropagation();
  location.href = "../../left2.html";
});
var replay = document.querySelector(".replay");
replay.addEventListener("click", function (e) {
  localStorage.setItem("hullabaloo", '{"me":0,"spock":0}');
  e.stopPropagation();
  location.reload();
});
