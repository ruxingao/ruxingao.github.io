(function (y, J, u) {
        ...
        f
          ? ((b = r * w(f.a)),
            ...
            e
              ...
              .textAlign("right")
              .fillStyle("#f00")
              .fillText("\u6302\u4e86\uff01", s - 10, k - 45)
              .fillText("1\u79d2\u540e\u91cd\u65b0\u5f00\u59cb", s - 10, k - 20)
              .restore(),
            setTimeout(G, 1e3))
          : 1 > b
          ? D(a, t)
          : (n.push(K(a - A)),
            ...
            B ||
              ((d = "pass"),
              localStorage.setItem("aaffuu-cxp", '{"aa":' + (l + 1) + "}"),
              e
                .save()
                .font("bold 18px sans-serif")
                .textAlign("right")
                .fillStyle("#060")
                .fillText("\u5b8c\u7f8e\u8fc7\u5173\uff01", s - 10, k - 45)
                .fillText("1\u79d2\u540e\u4e0b\u4e00\u5173", s - 10, k - 20)
                .restore(),
              setTimeout(G, 1e3)));
      }
      e.save()
  ...
  function T(a) {
    if ("idle" == d) {
      V ||
        ["mousedown", "touchstart", "MSPointerDown", "pointerdown"].forEach(
          function (b) {
  ...
  function G() {
    if (!d || "over" == d || "pass" == d) {
      ...
      z = { b: a[0], c: a[1], d: a[2] || (l % 2 ? "anti" : "normal") };
      a = z.b;
  ...
  n = H.concat();
  F = 4 * u.asin(h / 2 / r);
  ["mousedown", "touchstart", "MSPointerDown", "pointerdown"].forEach(function (
    a
  ) {
...
replay.addEventListener("click", function (e) {
  localStorage.setItem("aaffuu-cxp", '{"aa":1}');
  e.stopPropagation();
  location.reload();
});
